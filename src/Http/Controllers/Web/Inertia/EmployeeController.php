...
class EmployeeController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('karyawan/employee/index', [
            'employees' => $employees,
    ...
    {
        return Inertia::render('karyawan/employee/create', $this->formOptions());
    }
    ...
    {
        return Inertia::render('karyawan/employee/show', [
    ...
    {
        return Inertia::render('karyawan/employee/edit', array_merge(
