...
class CreateEmployeeRequest extends FormRequest
{
    ...
    {
        return true; // Otorisasi ditangani oleh Policy di controller
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'employee_code' => ['nullable', 'string', 'max:50', Rule::unique($employeesTable, 'employee_code')],
            'user_id' => ['nullable', 'integer', Rule::unique($employeesTable, 'user_id')],
            ...
            'manager_employee_id' => ['nullable', 'integer', 'exists:'.$employeesTable.',id'],

            'full_name' => ['required', 'string', 'max:255'],
            'nick_name' => ['nullable', 'string', 'max:100'],
            'work_email' => ['nullable', 'email', 'max:255', Rule::unique($employeesTable, 'work_email')],
    ...
    {
        return [
            'employee_code' => __('karyawan::validation.attributes.employee_code'),
